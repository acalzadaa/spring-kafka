...
import com.alex.core.model.Customer;
import com.alex.core.service.KafkaProducerService;
...
public class KafkaController {
	...
	public Customer sendMessageToCustomerToKafkaTopic(Customer customer) {
		...
		this.producerService.sendCustomerMessage(new Customer("Alex", "Calzada", "Algravez"));
		return new Customer("Alex", "Calzada", "Algravez");
	}
